...
typedef enum{CCO_MISSION_ACCEPT=10,CCO_MISSION_DENY, CCO_AGV_STATUS, CCO_MISSION_STEP_REACHED, CCO_IBE_RECIEVED, CCO_EMERGENCY_STOP, CCO_PRIORITY_STOP,CCO_MISSION_ABORT,CCO_MISSION_PAUSE,CCO_CONTINUE_SEND} MSG_SEND_HEADER_T; //All the headers that could be sent
