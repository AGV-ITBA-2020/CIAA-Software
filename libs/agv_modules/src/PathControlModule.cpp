...
// 	for( ;; )
// 	{ //Podr�a fijarse que si la distTravelled da mayor a lo esperado en distancias a recorrer que se quede ah� (viendo la estructura de la misi�n)
// 		if(state==PC_RUN) //Solo actualiza la distancia cuando est� corriendo el programa
...
{
	return MC_getDistanceTravelled();
}
